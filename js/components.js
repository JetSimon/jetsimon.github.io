...
Vue.component('blog-post', {
    ...
    <div class="bg-white text-center w-full font-sans px-5">
        <div>
            ...
            <hr>
            <p class="my-5 text-center">Got any questions or comments? <a rel="me" href="https://mastodon.gamedev.place/@SimonJet" class="hover:text-blue-800 font-semibold text-gray-800">Ask me on Mastodon</a>!</p>
        </div>
    </div>
    `,
    computed: {
