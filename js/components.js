...
Vue.component('blog-post', {
    ...
    <div class="bg-white text-center w-full font-sans px-5">
        <div>
            ...
            <hr>
            <p class="pl-20 my-5 text-left">Like what you've read? <a href="https://twitter.com/SimonJet" class="hover:text-blue-800 font-semibold text-gray-800">Follow me on Twitter</a> to see more!</p>
        </div>
    </div>
    `,
    computed: {
